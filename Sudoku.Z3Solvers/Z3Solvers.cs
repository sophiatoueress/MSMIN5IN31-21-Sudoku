...
namespace Sudoku.Z3Solvers
{
    ...
    public abstract class Z3SolverBase : ISolverSudoku
    {
        ...
        BoolExpr GetPuzzleConstraint(SudokuGrid instance)
        {
        ...
        protected SudokuGrid SolveWithSubstitutions(SudokuGrid instance)
        {
        ...
        protected SudokuGrid SolveWithAsumptions(SudokuGrid instance)
        {
        ...
        protected SudokuGrid SolveWithScope(SudokuGrid instance)
        {
        ...
        protected SudokuGrid SolveOriginalCleanup(SudokuGrid instance)
        {
        ...
        protected SudokuGrid SolveOriginalVersion(SudokuGrid instance)
        {
            BoolExpr instance_c = z3Context.MkTrue();
            for (int i = 0; i < 9; i++)
                for (int j = 0; j < 9; j++)
