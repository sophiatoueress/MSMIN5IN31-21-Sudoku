...
namespace Sudoku.GeneticAlgorithmSolver
{
    ...
    public class SudokuPermutationsChromosome : ChromosomeBase, ISudokuChromosome
    {
        ...
        /// </summary>
        protected readonly SudokuGrid TargetSudoku;
        ...
        public SudokuPermutationsChromosome(SudokuGrid targetSudoku) : this(targetSudoku, 9)
        {
        ...
        public SudokuPermutationsChromosome(SudokuGrid targetSudoku, int length) : base(length)
        {
