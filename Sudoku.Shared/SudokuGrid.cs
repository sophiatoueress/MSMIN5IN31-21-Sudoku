...
namespace Sudoku.Shared
{
    public class SudokuGrid : ICloneable
    {
        ...
        ///// </summary>
        //public static readonly ReadOnlyCollection<int> CellIndices = new ReadOnlyCollection<int>(Enumerable.Range(0, 81).ToList());
        ...
        public static SudokuGrid Parse(string sudokuAsString)
        {
        ...
        public static List<SudokuGrid> ParseFile(string fileName)
        {
        ...
        /// <returns>the list of parsed Sudokus</returns>
        public static List<SudokuGrid> ParseMulti(string[] lines)
        {
